...
/**
 * Fetch Recent Posts or Return Dynamic Fallback Content.
 *
...
function bhaiyyantop_get_recent_posts( $args = array() ) {
    ...
    return bhaiyyantop_get_mock_posts( $parsed_args );
}
...
function bhaiyyantop_get_mock_posts( $args = array() ) {
    ...
    $number = isset( $args['numberposts'] ) ? (int) $args['numberposts'] : 10;
    return array_slice( $mock_all, 0, $number );
}
